...
export const UI = {
  uk: {
    ...
    'warn': '⚠ Автор — Ihor Ivaniuk (@IBITLAB): ідея, задачі, рішення; модель, розрахунки й код зробив ШІ (Claude Code). Інженер їх не перевіряв, машину не збудовано й не випробувано. Використання — на власний ризик; небезпеки конструкції — у SAFETY.md.',
    'warn.short': '⚠ Зроблено за допомогою ШІ — інженер не перевіряв',
  ...
  en: {
    ...
    'warn': '⚠ By Ihor Ivaniuk (@IBITLAB): idea, tasks, decisions; the model, the calculations and the code were made by AI (Claude Code). No engineer has checked them, and no machine has been built or tested. Use at your own risk; the hazards of this design are in SAFETY.md.',
    'warn.short': '⚠ Made with AI — no engineer has checked it',

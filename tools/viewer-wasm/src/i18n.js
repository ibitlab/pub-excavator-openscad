...
export const UI = {
  uk: {
    ...
    'help': 'ліва кнопка — обертання · права / Shift — панорама · коліщатко — масштаб · подвійний клік — центр обертання · 1–6 — види, пробіл — цикл · SpaceMouse — у «Розширених можливостях»',
  ...
  en: {
    ...
    'reset': 'Reset all',
    'copy': 'Copy changes',
    'help': 'left button — orbit · right / Shift — pan · wheel — zoom · double click — set orbit centre · 1–6 — views, space — dig cycle · SpaceMouse — under “Advanced”',

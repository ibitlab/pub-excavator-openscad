...
> ⚠️ **Generated by AI — not checked by an engineer, never built, never tested.** The full disclaimer is in [README.md](README.md#disclaimer); the hazards specific to this design are in [SAFETY.md](SAFETY.md).

...
- **від висунення — натягом рукава на штоку:** рукав 5 мм сидить із натягом (FDM сам
...
з brim, шар 0.2. Обхват 225°: губки при защіпанні розходяться на ~9 %, PLA витримує,
PETG пружніший. Губки скруглені, щоб наїжджати на деталь без зусилля й не дряпати її.
Спадає зі штока — `CLIP_FIT = -0.1` у `stand.scad`, туго на гільзі — `+0.1`; штуцер не
входить — збільшити `CLIP_PORT_FIT`.
...
циліндрі з набору зі штоком на 40 % ходу: з гільзою і штоком не перетинається, а без

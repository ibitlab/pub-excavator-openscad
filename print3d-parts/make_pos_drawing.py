...
пар і габарити бази — параметри моделі через `echo(GEO)`. Поряд із картинкою
пишеться positions.json, з якого make_assembly.py будує таблицю, тож картинка
й таблиця не можуть розійтися.

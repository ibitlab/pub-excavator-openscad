...
|---|---|---|---|---:|---|
| `44_pin_C` | Ø7.2 × 15.3 | `46_pin_D` | Ø7.2 × 15.3 | — | **однакові — взаємозамінні** |
...
| `44_pin_C` | Ø7.2 × 15.3 | `48_pin_F` | Ø6.2 × 14.7 | 1.0 | Ø: 7.2 проти 6.2 |
| `44_pin_C` | Ø7.2 × 15.3 | `50_pin_H` | Ø6.2 × 14.7 | 1.0 | Ø: 7.2 проти 6.2 |
...
| `36_R_bushing` | Ø9.0 × 16.0 | `44_pin_C` | Ø7.2 × 15.3 | 1.8 | Ø: 9.0 проти 7.2 |
| `36_R_bushing` | Ø9.0 × 16.0 | `46_pin_D` | Ø7.2 × 15.3 | 1.8 | Ø: 9.0 проти 7.2 |
| `41_bk_spacer_Q` | Ø9.0 × 16.4 | `44_pin_C` | Ø7.2 × 15.3 | 1.8 | Ø: 9.0 проти 7.2 |
...
| 1.4 | `05_cover` | 1 | 62.4 × 16.0 × 21.0 | — | зверху на перелом, між щоками | Уже зігнута посередині на 35°, лягає одразу на обидві верхні полиці |
...
| 1.8 | `08_F_tower` | 2 | 27.8 × 31.0 × 2.4 | [аркуш](../versions/V001-2026-09-20-0505/drawings/png/09_F_tower.png) | на верхню накладку перелому | Основа вся на сегменті 1, від −150 до −12 мм від вершини; уперед не можна — там проходить корпус циліндра |
| 1.9 | `07_D_saddle` | 1 | 52.0 × 16.0 × 2.0 | — | знизу між щоками перелому | Сідло стає врівень із виступами щік |
| 1.10 | `06_D_clevis` | 2 | 41.4 × 24.2 × 2.4 | [аркуш](../versions/V001-2026-09-20-0505/drawings/png/08_D_clevis.png) | на сідло D | Дві пластини; проміжок 30 мм під вушко штока |
...
| 2.6 | `13_H_clevis` | 2 | 22.1 × 18.5 × 2.4 | [аркуш](../versions/V001-2026-09-20-0505/drawings/png/13_H_clevis.png) | на сідло H | Дві пластини; основа тягнеться назад — уперед плечей немає, туди лягає корпус циліндра |
...
| 3.5 | `22_bk_ear` | 2 | 23.2 × 44.4 × 2.4 | [аркуш](../versions/V001-2026-09-20-0505/drawings/png/18_bk_ear.png) | на накладку верху | Два вуха під осі E і Q |
...
| 7.2 | `44_pin_C` | 1 | Ø7.2 × 15.3 | — | база циліндра стріли на плити колони | Такий самий, як палець D — у металі це одна позиція на дві штуки |

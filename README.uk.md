...
- Початкові значення параметрів можна задати в адресі: `?boom_L1=1000&view=iso`. Модель вшивається у сторінку під час збирання, і **відкрити в ній чужий `.scad` не можна** — це прибрано навмисно: текст такого файлу став би назвами груп, описами й попередженнями в панелі, тобто чужими даними в сторінці, яка живе на спільному домені GitHub Pages.
